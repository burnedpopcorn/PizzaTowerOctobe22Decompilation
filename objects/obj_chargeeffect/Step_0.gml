...
if (playerid.state != states.rocket && playerid.state != states.mach3 && playerid.ratmount_movespeed < 12 && playerid.state != states.crouchslide && playerid.state != states.shoulderbash)
    instance_destroy();
