...
function robot_create(arg0, arg1)
{
...
function blob_create(arg0, arg1)
{
...
function puppet_create(arg0, arg1)
{
    instance_create_unique(0, 0, obj_puppetmonster);
}

function hillbilly_create(arg0, arg1)
{
...
function grid_meeting(arg0, arg1)
{
    if (arg0 < 0 || arg0 > (map_width - 1) || arg1 < 0 || arg1 > (map_height - 1))
        return false;
    
    if (room_grid[# arg0, arg1] != noone)
        return true;
    
    return false;
}

function grid_length_x(arg0, arg1, arg2)
{
    var count = 0;
    
    while (grid_meeting(arg0 + arg2, arg1))
    {
        count++;
        arg0 += arg2;
    }
