...
add_achievement_notify("farm2", -4, function(arg0)
{
    var type = arg0[0];
...
add_achievement_notify("beach1", function()
{
}, function(arg0)
{
    var type = arg0[0];
    ...
    if (type == UnknownEnum.Value_10 && global.leveltosave == "plage" && arr[1] == 594 && arr[3] == 461)
...
}, function(arg0)
{
    ...
    if (type == UnknownEnum.Value_11 && global.leveltosave == "plage" && arr[1] == 582)
    {
...
}, function(arg0)
{
    ...
    if (type == UnknownEnum.Value_5 && global.leveltosave == "plage" && arr[2] == 519)
...
add_achievement_update("forest1", 5, -4, function()
{
...
}, function(arg0)
{
    ...
    if (type == UnknownEnum.Value_12 && global.leveltosave == "forest" && (arr[0] == 401 || arr[0] == 420))
    {
...
}, function(arg0)
{
    ...
    if (type == UnknownEnum.Value_10 && global.leveltosave == "forest" && arr[1] == 593 && arr[3] == 572)
...
}, function(arg0)
{
    ...
    if (type == UnknownEnum.Value_12 && global.leveltosave == "space" && arr[0] == 439)
    {
...
}, function(arg0)
{
    ...
    if (type == UnknownEnum.Value_13 && (arr[0] == 664 || arr[0] == 176))
    {
...
}, function(arg0)
{
    ...
    if (type == UnknownEnum.Value_16 && arr[0] == 3305)
    {
...
}, function(arg0)
{
    ...
    if (type == UnknownEnum.Value_14 && (arr[0] == 464 || arr[0] == 464))
    {
...
add_achievement_update("street1", 60, -4, function()
{
...
}, function(arg0)
{
    ...
    if (global.leveltosave == "sewer" && type == UnknownEnum.Value_2 && arr[1] == 612)
    {
...
}, function(arg0)
{
    ...
    {
        if (type == UnknownEnum.Value_0 && arr[2] == 187)
            achievement_get_variable("i2_count").value += 1;
        else if (type == UnknownEnum.Value_5)
            achievement_get_variable("i2_hurt").value = true;
    }
    
    if (type == UnknownEnum.Value_24 && arr[0] == 62 && achievement_get_variable("i2_hurt").value == false && achievement_get_variable("i2_count").value >= 13)
...
}, function(arg0)
{
    ...
    if (global.leveltosave == "industrial" && type == UnknownEnum.Value_0 && arr[2] == 590)
    {
...
}, function(arg0)
{
    ...
    if (global.leveltosave == "freezer" && type == UnknownEnum.Value_0 && arr[2] == 832)
    {
...
}, function(arg0)
{
    ...
    if (global.leveltosave == "chateau" && type == UnknownEnum.Value_0 && arr[2] == 224)
    {
...
}, function(arg0)
{
    ...
    if (type == UnknownEnum.Value_5 && (arr[2] == 490 || arr[2] == 262))
