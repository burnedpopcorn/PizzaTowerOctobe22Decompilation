...
player_hurtstates[? states.handstandjump] = 30;
player_hurtstates[? states.chainsawbump] = 50;
player_hurtstates[? states.mach2] = 20;
player_hurtstates[? states.mach3] = 30;
player_hurtstates[? states.freefall] = 20;
player_hurtstates[? states.punch] = 20;
player_hurtstates[? states.tumble] = 20;
player_hurtstates[? states.Sjump] = 20;
boss_hurtstates[? states.shoulder] = 60;
boss_hurtstates[? states.shoulderbash] = 60;
boss_hurtstates[? states.supershoulderbash] = 90;
boss_hurtstates[? states.superslam] = 200;
boss_hurtstates[? states.punch] = 30;
boss_hurtstates[? states.freefall] = 70;
...
function player_destroy(arg0)
{
    SUPER_player_destroy(arg0);
}
...
{
    if (arg1.state != states.backbreaker || arg1.parry_inst == noone)
    {
