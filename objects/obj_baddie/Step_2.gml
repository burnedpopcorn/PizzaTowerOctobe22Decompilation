...
if (sprite_index == walkspr && state != states.chase && ANIMATION_PLAYING)
    steppy = false;

if (sprite_index == walkspr && hsp != 0 && sign(hsp) == sign(image_xscale) && grounded && vsp > 0 && ANIMATION_ENDED && !steppy && object_index != obj_ghoul && state != states.chase)
{
    steppy = true;
