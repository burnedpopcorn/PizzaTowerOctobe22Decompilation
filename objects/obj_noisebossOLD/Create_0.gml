...
attack_type[states.handstandjump] = [noise_dist.close, noise_dist.close];
attack_type[states.jump] = [noise_dist.anywhere, noise_dist.close];
attack_type[states.skateboard] = [noise_dist.far, noise_dist.far];
attack_type[states.skateboardturn] = [noise_dist.anywhere, noise_dist.anywhere];
attack_type[states.throwing] = [noise_dist.anywhere, noise_dist.anywhere];
attack_type[states.bombkick] = [noise_dist.far, noise_dist.far];
attack_type[states.pogo] = [noise_dist.anywhere, noise_dist.anywhere];
attack_type[states.bombpogo] = [noise_dist.anywhere, noise_dist.anywhere];
attack_type[states.jetpackstart] = [noise_dist.anywhere, noise_dist.anywhere];
attack_type[states.jetpackcancel] = [noise_dist.anywhere, noise_dist.anywhere];
attack_type[states.jetpackspin] = [noise_dist.close, noise_dist.close];
current_behaviour = noise_dist.none;
current_attack = states.handstandjump;
state = states.arenaround;
player_hurtstates[? states.handstandjump] = 30000;
player_hurtstates[? states.chainsawbump] = 50;
player_hurtstates[? states.mach2] = 20;
player_hurtstates[? states.mach3] = 30;
boss_hurtstates[? states.punch] = 30;
boss_hurtstates[? states.handstandjump] = 30;
boss_hurtstates[? states.crouchslide] = 30;
boss_hurtstates[? states.skateboard] = 60;
boss_hurtstates[? states.pogo] = 30;
boss_hurtstates[? states.jetpack] = 80;
boss_hurtstates[? states.jetpackspin] = 80;
phase = 1;
max_phase = 9;
