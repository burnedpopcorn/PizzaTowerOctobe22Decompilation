...
attack_pool[1] = [states.skateboard, UnknownEnum.Value_167];
attack_pool[2] = [states.handstandjump, states.throwing, UnknownEnum.Value_168];
attack_pool[3] = [states.pogo, UnknownEnum.Value_169];
attack_pool[4] = [states.jetpackstart, UnknownEnum.Value_172, UnknownEnum.Value_173];
attack_pool[5] = [states.handstandjump, states.jump, states.skateboard, UnknownEnum.Value_167, states.throwing, UnknownEnum.Value_168, states.pogo, UnknownEnum.Value_169, states.jetpackstart, UnknownEnum.Value_172, UnknownEnum.Value_173];
attack_pool[6] = [states.handstandjump, states.jump, states.skateboard, UnknownEnum.Value_167];
attack_pool[7] = [states.handstandjump, states.throwing, UnknownEnum.Value_168, states.pogo, UnknownEnum.Value_169];
attack_pool[8] = [states.jetpackstart, UnknownEnum.Value_172, UnknownEnum.Value_173];
...
attack_type[UnknownEnum.Value_167] = [UnknownEnum.Value_3, UnknownEnum.Value_3];
attack_type[UnknownEnum.Value_74] = [UnknownEnum.Value_3, UnknownEnum.Value_3];
attack_type[UnknownEnum.Value_168] = [UnknownEnum.Value_2, UnknownEnum.Value_2];
attack_type[UnknownEnum.Value_58] = [UnknownEnum.Value_3, UnknownEnum.Value_3];
attack_type[UnknownEnum.Value_169] = [UnknownEnum.Value_3, UnknownEnum.Value_3];
attack_type[UnknownEnum.Value_170] = [UnknownEnum.Value_3, UnknownEnum.Value_3];
attack_type[UnknownEnum.Value_172] = [UnknownEnum.Value_3, UnknownEnum.Value_3];
attack_type[UnknownEnum.Value_173] = [UnknownEnum.Value_1, UnknownEnum.Value_1];
...
ds_map_set(boss_hurtstates, UnknownEnum.Value_173, 80);
phase = 1;
max_phase = 9;
...
function boss_destroy(arg0)
{
    SUPER_boss_destroy(arg0);
    targetstunned = 1000;
    stunned = 1000;
