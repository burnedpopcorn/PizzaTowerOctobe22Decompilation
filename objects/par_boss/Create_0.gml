...
function SUPER_player_destroy(arg0)
{
    depth = arg0.depth;
...
function SUPER_boss_destroy(arg0)
{
    destroyed = true;
    depth = arg0.depth;
...
function SUPER_boss_hurt(arg0, arg1)
{
    if (important)
        hp -= arg0;
    
    if (arg1.state != states.playersuperattack)
    {
...
function SUPER_boss_hurt_noplayer(arg0)
{
    if (important)
        hp -= arg0;
