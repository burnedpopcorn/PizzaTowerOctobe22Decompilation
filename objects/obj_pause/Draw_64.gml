...
if (fade > 0)
{
    ...
    {
        draw_set_alpha(1);
        draw_sprite_ext(screensprite, 0, 0, 0, SCREEN_WIDTH / surface_get_width(application_surface), SCREEN_HEIGHT / surface_get_height(application_surface), 0, c_white, 1);
