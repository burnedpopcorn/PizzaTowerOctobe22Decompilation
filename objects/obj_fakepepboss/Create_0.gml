...
fakepep_add_bodyslamclone(0, 1, 1, 45);
fakepep_add_bodyslamclone(0, 1, -1, 45);
...
var size = 10;
var timer = 5;
fakepep_add_superjumpclones(0, 3, 1, timer, size, 8, 30);
fakepep_add_superjumpclones(0, 3, -1, timer, size, 2, 30);
fakepep_add_superjumpclones(0, 3, 1, timer, size, 6, 30);
fakepep_add_superjumpclones(0, 3, -1, timer, size, 3, 30);
fakepep_add_superjumpclones(0, 3, 1, timer, size, 10, 30);
fakepep_add_superjumpclones(0, 3, -1, timer, size, 0, 30);
...
fakepep_add_machclone(0, 5, 1, 30, true);
