if (global.levelcompletename == "SPACE")
{
    if (global.levelcomplete && !global.spacecutscene && global.levelcompletename == "SPACE")
    {
		...
		[
			...
			[cutscene_set_player_pos, 1152, 238], 
			[cutscene_wait, 39], 
			[cutscene_space_middle], 
			[cutscene_wait, 150], 
...
else if (global.levelcomplete && !global.farmcutscene)
{
	...
	[
		...
		[cutscene_set_player_visible, false], 
		[cutscene_player_float, true], 
		[cutscene_set_player_pos, 966, 274], 
		[cutscene_wait, 10], 
		[cutscene_farm_middle], 
		[cutscene_change_room, hub_golf], 
		[cutscene_player_float, true], 
		[cutscene_set_player_pos, 555, 370], 
		[cutscene_wait, 10], 
		[cutscene_farm_middle], 
		[cutscene_change_room, currentroom], 
		[cutscene_player_float, false], 
