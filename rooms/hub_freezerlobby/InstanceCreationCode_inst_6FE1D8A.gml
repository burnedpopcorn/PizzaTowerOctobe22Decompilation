if (global.levelcomplete && !global.freezercutscene)
{
    ...
    currentroom = room;
    dragonactor = 119789;
    scene_info = [[cutscene_medieval_start], [cutscene_waitfor_sprite, 464], [function()
    {
        with (obj_actor)
        {
    ...
    }], [cutscene_change_room, 245], [cutscene_set_player_visible, false], [cutscene_set_player_pos, 1407, 415], [cutscene_wait, 20], [function()
    {
    ...
    }], [cutscene_soundeffect, 26], [cutscene_camera_shake, 5, 3 / room_speed], [function()
    {
        with (dragonactor)
        {
            if (ANIMATION_ENDED)
    ...
    }], [cutscene_wait, 50], [function()
    {
        ...
        cutscene_end_action();
    }], [cutscene_wait, 50], [cutscene_change_room, 231], [cutscene_set_player_visible, false], [cutscene_set_player_pos, 190, 600], [cutscene_soundeffect, 26], [cutscene_camera_shake, 5, 3 / room_speed], [cutscene_wait, 50], [function()
    {
        with (obj_freezerblock)
            instance_destroy();
