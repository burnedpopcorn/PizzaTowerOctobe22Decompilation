...
else if (global.levelcomplete && !global.beachcutscene && global.levelcompletename != "FOREST")
{
    ...
    peppermanactorID = -4;
    boatactorID = -4;
    scene_info = [[cutscene_entrance_start], [cutscene_waitfor_sprite, 464], [cutscene_player_idleanim], [cutscene_change_room, 86], [cutscene_set_player_visible, false], [cutscene_player_float, true], [cutscene_set_player_pos, 923, 281], [cutscene_wait, 60], [function()
    {
    ...
    }], [cutscene_camera_shake, 4, 3 / room_speed], [cutscene_soundeffect, 26], [cutscene_wait, 60], [cutscene_change_room, currentroom], [cutscene_player_float, false], [cutscene_set_player_visible, true], [cutscene_beach_end]];
}
else
{
    scene_info = [[cutscene_wait, 20]];
