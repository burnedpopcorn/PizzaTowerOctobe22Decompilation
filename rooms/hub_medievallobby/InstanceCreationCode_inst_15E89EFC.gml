...
else if (global.levelcomplete && !global.chateaucutscene)
{
    ...
    currentroom = room;
    scene_info = [[cutscene_entrance_start], [cutscene_waitfor_sprite, 464], [cutscene_player_idleanim], [cutscene_change_room, 184], [cutscene_set_player_visible, false], [cutscene_set_player_pos, 1888, 369], [cutscene_wait, 100], [cutscene_change_room, currentroom], [cutscene_set_player_visible, true], [function()
    {
        with (obj_player)
        {
            state = states.normal;
