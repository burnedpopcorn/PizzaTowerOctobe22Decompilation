function state_player_jump()
{
    ...
    if (key_slap2 && sprite_index != spr_suplexbump && shotgunAnim == false && !global.pistol)
    {
    ...
    if (key_slap2 && shoot)
    {
        if (!shotgunAnim)
        {
            ...
            if (!instance_exists(parry_inst) && flash == true)
            {
                ...
                var _playerid = obj_hardmode;
                
                if (object_index == obj_player2)
                    _playerid = obj_bosskeynoise;
    ...
    switch (character)
    {
        ...
        case "V":
            ...
            if (sprite_index == spr_playerV_superjump && ANIMATION_ENDED)
...
function state_pepperman_jump()
{
    ...
    if (sprite_index == spr_jump && ANIMATION_ENDED)
        sprite_index = spr_fall;
    
    if (sprite_index == spr_player_pistoljump1 && ANIMATION_ENDED)
        sprite_index = spr_player_pistoljump2;
