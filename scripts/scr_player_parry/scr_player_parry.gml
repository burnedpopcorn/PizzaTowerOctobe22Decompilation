function scr_player_parry()
{
    ...
    if (!fmod_event_instance_is_playing(global.snd_parry))
        scr_fmod_soundeffect(global.snd_parry, x, y);
    ...
    if (parry_count > 0)
    {
        ...
        with (obj_baddie)
        {
            ...
            {
                notification_push(notifs.enemy_parried, [id, object_index, room]);
