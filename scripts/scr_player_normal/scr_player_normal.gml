function state_player_normal()
{
    ...
    if (sprite_index == spr_player_breakdance && breakdance_speed > 0.4 && !shotgunAnim)
    {
    ...
    else if ((key_slap2 || input_buffer_slap < 8) && key_up && shotgunAnim == false && !global.pistol)
    {
        state = states.punch;
        image_index = 0;
