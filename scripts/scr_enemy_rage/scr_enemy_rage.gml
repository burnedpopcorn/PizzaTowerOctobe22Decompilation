function scr_enemy_rage()
{
    switch (object_index)
    {
        ...
        case obj_minijohn:
            ...
            if (sprite_index == spr_minijohn_rage1 && ANIMATION_ENDED)
        ...
        case obj_ancho:
            ...
            if (ANIMATION_ENDED && sprite_index == spr_ancho_rage1)
            ...
            if (ANIMATION_ENDED && sprite_index == spr_ancho_rage3)
            {
                state = states.walk;
        ...
        case obj_tank:
            ...
            if (ANIMATION_ENDED && sprite_index == spr_tank_chargestart)
