function scr_collide_destructibles()
{
    with (obj_player)
    {
        if ((state == states.jump && sprite_index == spr_playerN_noisebombspinjump) || ghostdash == true || state == states.slipbanan || state == states.rideweenie || state == states.trickjump || state == states.ratmountbounce || (state == states.pogo && pogochargeactive == true))
        {
