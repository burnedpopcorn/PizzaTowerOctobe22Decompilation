function scr_player_ratmount()
{
    ...
    if (input_buffer_jump < 8 && !key_up && grounded && gusdashpadbuffer == 0)
    {
    ...
    if (((key_slap2 && key_up) || key_shoot2) && brick && gusdashpadbuffer == 0)
    {
        ratmount_kickbrick();
    ...
    if (key_slap2 && !key_up && gusdashpadbuffer == 0)
    {
        if (brick == true)
        {
