function scr_player_chainsawbump()
{
    ...
    if (ANIMATION_ENDED && sprite_index == spr_player_chainsawrev)
    ...
    if (ANIMATION_ENDED && sprite_index == spr_player_chainsawdashstart)
    {
    ...
    if (ANIMATION_ENDED && (sprite_index == spr_player_chainsawhit || sprite_index == spr_player_chainsawdash))
    {
        if (key_attack)
            state = states.mach2;
        else
    ...
    if (ANIMATION_ENDED && sprite_index == spr_player_chainsawhitwall)
        state = states.normal;
