function scr_collide_player()
{
    ...
    if (platformid != noone || (place_meeting(x, y + 1, obj_movingplatform) && !place_meeting(x, y - 3, obj_movingplatform)) || place_meeting(x, y + 8, 158 && !place_meeting(x, y + 6, obj_movingplatform)))
        grounded = true;
