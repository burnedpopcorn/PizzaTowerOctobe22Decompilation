function scr_player_mach3()
{
    switch (character)
    {
        case "P":
            ...
            if (fightball == false)
            {
                if (sprite_index == spr_mach3jump && ANIMATION_ENDED)
                    sprite_index = spr_mach4;
                
                if (sprite_index == spr_player_Sjumpcancel && grounded)
                    sprite_index = spr_mach4;
                
                if (ANIMATION_ENDED && (sprite_index == spr_rollgetup || sprite_index == spr_mach3hit || sprite_index == spr_dashpadmach))
                    sprite_index = spr_mach4;
                ...
                if (movespeed > 16 && sprite_index != spr_crazyrun && sprite_index != spr_player_Sjumpcancelstart && sprite_index != spr_taunt)
                {
                    ...
                    repeat (2)
                    {
                        with (create_debris(x, y, spr_flashdots, true))
                        {
            ...
            if (key_down && fightball == false && sprite_index != spr_dashpadmach)
            {
                particle_set_scale(particle.jumpdust, xscale, 1);
                create_particle(x, y, particle.jumpdust, 0);
                flash = false;
            ...
            if (key_slap2 && shotgunAnim == false && !global.pistol && sprite_index != spr_dashpadmach)
            {
        ...
        case "V":
            ...
            if ((!grounded && place_meeting(x + hsp, y, obj_solid) && (!place_meeting(x + sign(hsp), y, 450 || scr_solid_slope(x + sign(hsp), y)) && !place_meeting(x + hsp, y, obj_mach3solid))) || (grounded && (place_meeting(x + hsp, y - 32, obj_solid) || scr_solid_slope(x + sign(hsp), y - 32)) && place_meeting(x, y + 1, obj_slope) && !place_meeting(x + hsp, y, obj_mach3solid)))
            {
                wallspeed = 10;
                state = states.climbwall;
            }
    ...
    if (key_up && fightball == false && state == states.mach3 && character == "P" && grounded && vsp > 0 && sprite_index != spr_dashpadmach && !place_meeting(x, y, obj_dashpad))
    {
